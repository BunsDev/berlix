    ...
    <div className="w-full flex-col bg-white dark:bg-neutral-950 text-neutral-800 dark:text-white relative">
      ...
      <div className="mx-auto max-w-[1536px] text-white flex flex-1 space-x-16">
        ...
        <main className="flex-1 py-6  pb-16 pt-8 min-w-0">
          <div className="prose prose-zinc dark:prose-invert prose-h1:text-3xl prose-h1:font-semibold prose-h2:text-xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-medium prose-h3:scroll-m-20 max-w-full">
            {children}
          </div>
        </main>
